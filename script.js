...
function showResult(){
    ...
    if (userScore > 3){ // if user scored more than 3
        ...
        let scoreTag = '<span> Su planta posee parasitos😐. Los resultados son: <p>'+ userScore +'</p> de <p>'+ questions.length + '</p></span>';
        scoreText.innerHTML = scoreTag;  //adding new span tag inside score_Text
    }
    else if(userScore > 1){ // if user scored more than 1
        let scoreTag = '<span> Su planta está en un estado no critico. Los resultados son:  <p>'+ userScore +'</p> de  <p>'+ questions.length +'</p></span>';
        scoreText.innerHTML = scoreTag;
    }
    else{ // if user scored less than 1
        let scoreTag = '<span> 🎉¡Tu planta no tiene parasitos!🎉. Los resultados son:   <p>'+ userScore +'</p> de  <p>'+ questions.length +'</p></span>';
        scoreText.innerHTML = scoreTag;
    }
}
